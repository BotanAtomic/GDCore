...
public class Items extends TableImpl<ItemsRecord> {
    ...
    private static final long serialVersionUID = -705834708;
     ...
     */
    public final TableField<ItemsRecord, Integer> OWNER = createField("owner", org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    public List<UniqueKey<ItemsRecord>> getKeys() {
        return Arrays.<UniqueKey<ItemsRecord>>asList(Keys.KEY_ITEMS_GUID);
    }
