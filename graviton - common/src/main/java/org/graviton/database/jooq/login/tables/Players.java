...
public class Players extends TableImpl<PlayersRecord> {
    ...
    private static final long serialVersionUID = -740466477;
     ...
     */
    public final TableField<PlayersRecord, Byte> ALIGNMENT = createField("alignment", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>login.players.honor</code>.
     */
    public final TableField<PlayersRecord, Integer> HONOR = createField("honor", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>login.players.dishonnor</code>.
     */
    public final TableField<PlayersRecord, Integer> DISHONNOR = createField("dishonnor", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>login.players.pvp_enabled</code>.
     */
    public final TableField<PlayersRecord, Byte> PVP_ENABLED = createField("pvp_enabled", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");
     ...
     */
    public final TableField<PlayersRecord, Integer> GUILD = createField("guild", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<PlayersRecord, String> SAVEDLOCATION = createField("savedLocation", org.jooq.impl.SQLDataType.CLOB, this, "");
