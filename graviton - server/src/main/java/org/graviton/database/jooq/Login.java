...
public class Login extends SchemaImpl {
    ...
    private static final long serialVersionUID = -1330718864;
    /**
     * The table <code>login.accounts</code>.
     */
    public final Accounts ACCOUNTS = org.graviton.database.jooq.tables.Accounts.ACCOUNTS;

    /**
     * The table <code>login.players</code>.
     */
    public final Players PLAYERS = org.graviton.database.jooq.tables.Players.PLAYERS;

    /**
     * The table <code>login.servers</code>.
     */
    public final Servers SERVERS = org.graviton.database.jooq.tables.Servers.SERVERS;
