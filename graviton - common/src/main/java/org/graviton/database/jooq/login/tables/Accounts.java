...
public class Accounts extends TableImpl<AccountsRecord> {
    ...
    private static final long serialVersionUID = 1144889666;
     ...
     */
    public final TableField<AccountsRecord, String> FRIENDS = createField("friends", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

    /**
     * The column <code>login.accounts.enemies</code>.
     */
    public final TableField<AccountsRecord, String> ENEMIES = createField("enemies", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");
